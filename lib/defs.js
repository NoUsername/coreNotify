...
cnUtil.trace = cnUtil.nullCallback;
...
cnUtil.parseContent = function(content) {
	...
	htmlSummary += "</ul>";
	return [totalCount, htmlSummary, summary];
};
...
cnUtil.notifications2html = function(notifications) {
	cnUtil.log("notifications2html called");
	var summary = $("<div>");
